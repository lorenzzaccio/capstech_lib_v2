<?php
  ...
  $q="INSERT INTO proforma VALUES(null,'{$fact_date}','{$fact_com_id}','{$fact_num}','{$fact_delai_paiement}','{$fact_date_modif}','{$fact_total_ht}','{$fact_cout_ht}','{$fact_type_paiement}','{$fact_num_paiement}','{$fact_date_paiement}','{$fact_ref_paiement}')";
echo $q;
